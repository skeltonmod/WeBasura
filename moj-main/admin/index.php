        ...
        <div class="row">
          <div class="col-lg-9 main-chart">
            ...
            <div class="custom-bar-chart">
              ...
              <div class="bar">
                ...
                <div class="value tooltips" data-original-title="8.500" data-toggle="tooltip" data-placement="top">0%</div>
              </div>
              <div class="bar ">
                <div class="title">FEB</div>
                <div class="value tooltips" data-original-title="5.000" data-toggle="tooltip" data-placement="top">0%</div>
              </div>
              <div class="bar ">
                <div class="title">MAR</div>
                <div class="value tooltips" data-original-title="6.000" data-toggle="tooltip" data-placement="top">0%</div>
              </div>
              <div class="bar ">
                <div class="title">APR</div>
                <div class="value tooltips" data-original-title="4.500" data-toggle="tooltip" data-placement="top">0%</div>
              </div>
              <div class="bar">
                <div class="title">MAY</div>
                <div class="value tooltips" data-original-title="3.200" data-toggle="tooltip" data-placement="top">0%</div>
              </div>
              <div class="bar ">
          ...
          <div class="col-lg-3 ds">
            ...
            <div class="donut-main">
              ...
              <center>
              <canvas id="newchart" height="130" width="130"></canvas></center>
              <script>
                var doughnutData = [{
                    value: 0,
                    color: "#DFA94F"
