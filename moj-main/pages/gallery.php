...
<link href="../layout/styles/album.css" rel="stylesheet" type="text/css">
...
<div class="wrapper row3">
  <main class="hoc container clear"> 
    ...
    <div class="contenedor">
			...
			<div class="barra-busqueda" id="barra-busqueda" > </div>

			<div class="categorias" id="categorias">
				<a href="#" class="activo">All</a>
				<a href="#">Municipal Hall</a>
				<a href="#">Coastal Clean up</a>
			</div>	

		<section class="grid" id="grid">
<!-- Coastal Clean Up -->     
			<div class="item" 
      data-categoria="coastal clean up"> 
        <div class="item-contenido"><img src="../img/coastal/1.jpg" alt=""> </div>
        <div class="item-contenido"><img src="../img/coastal/2.jpg" alt=""> </div>
			</div>

      <div class="item" 
      data-categoria="coastal clean up"> 
        <div class="item-contenido"><img src="../img/coastal/5.jpg" alt=""> </div>
        <div class="item-contenido"><img src="../img/coastal/6.jpg" alt=""> </div>
			</div>

      <div class="item" 
      data-categoria="coastal clean up"> 
        <div class="item-contenido"><img src="../img/coastal/7.jpg" alt=""> </div>
        <div class="item-contenido"><img src="../img/coastal/10.jpg" alt=""> </div>
			</div>
<!-- ################################################################################################ -->      
<!-- Municipal Hall -->     
			<div class="item"
			data-categoria="municipal hall">
				<div class="item-contenido"><img src="../img/hall/3.jpg" alt=""></div>
        <div class="item-contenido"><img src="../img/hall/hall2.jpg" alt=""></div>
			</div>

      <div class="item"
			data-categoria="municipal hall">
				<div class="item-contenido"><img src="../img/hall/hall.jpg" alt=""></div>
			</div>

      <div class="item"
			data-categoria="municipal hall">
				<div class="item-contenido"><img src="../img/hall/hall1.jpg" alt=""></div>
			</div>
<!-- ################################################################################################ -->      
		...
		<section class="overlay" id="overlay">
			<div class="contenedor-img">
				<button id="btn-cerrar-popup"><i class="fa fa-times"></i></button>
				<img src="" alt="">
			</div>
    </section>
	</div>
    ...
    <script src="../layout/scripts/gallery.js"></script>
    </div>
    </div>
<!-- ################################################################################################ -->    
